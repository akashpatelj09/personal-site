...
See: [akashpatel.info](https://akashpatel.info).
...
* Special thanks to [Michael](https://github.com/mldangelo/) for the lovely personal site and inspiring to build one for myself.
